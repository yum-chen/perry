...
#[no_mangle]
pub unsafe extern "C" fn js_container_compose_down(handle_id: i64, volumes: f64) -> *mut Promise {
    let promise = js_promise_new();
...
#[no_mangle]
pub unsafe extern "C" fn js_workload_handle_logs(handle_id: i64, node_ptr: *const StringHeader, _opts_json_ptr: *const StringHeader) -> *mut Promise {
